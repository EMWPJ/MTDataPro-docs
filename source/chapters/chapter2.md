...
> **本章目标**：带你从零开始，一步步掌握大地电磁(MT)数据处理的完整流程，理解每个步骤背后的原理，学会使用MTDP软件获得高质量的处理结果。
...
---
⬅️ [返回目录](#) | ➡️ [下一节：理解MT基本原理](#22-第一步理解mt基本原理)
...
$$\begin{bmatrix} E_x \\ E_y \end{bmatrix} = \begin{bmatrix} Z_{xx} & Z_{xy} \\ Z_{yx} & Z_{yy} \end{bmatrix} \begin{bmatrix} H_x \\ H_y \end{bmatrix} \tag{2.3}$$
