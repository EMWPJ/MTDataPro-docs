...
地震目录模块用于管理地震数据，支持与MT测点进行空间关联分析。
...
| 数据源 | 格式 | 网址 |
|:------:|:----:|:-----|
| **USGS** | CSV/JSON | earthquake.usgs.gov |
| **中国地震台网** | CSV | www.ceic.ac.cn |
| **IRIS** | FFB | www.iris.edu |
| **自定义** | CSV | - |
...
| 格式 | 说明 | 用途 |
|:----:|:-----|:-----|
| **KML** | Google Earth格式 | 可视化展示 |
| **GPX** | GPS交换格式 | GPS设备导入 |
| **GeoJSON** | 地理JSON格式 | Web应用 |
| **SHP** | Shapefile格式 | GIS软件 |
